      ...
      <div class="collapse navbar-collapse navbar-collapse-1">
        ...
        <ul class="nav navbar-nav navbar-primary">
          <li class="<?php echo $link_val1;?>">
           ...
           <li class="<?php echo $link_val3;?>">
            <a href="<?php echo base_url();?>admin/traffic">Traffic</a>
          </li>
           <li class="<?php echo $link_val4;?>">
            <a href="<?php echo base_url();?>admin/analytics">Analytics</a>
          </li>
           <li class="<?php echo $link_val5;?>">
            <a href="<?php echo base_url();?>admin"><?php echo $role_name;?></a>
          </li>
        </ul>
      </div>
    </nav>
